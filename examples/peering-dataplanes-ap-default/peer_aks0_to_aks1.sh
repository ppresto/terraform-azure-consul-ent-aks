...
function setup () {
  ...
  kubectl -n consul get secret peering-token-consul1-westus2 --context aks0 -o yaml | kubectl apply --context aks1 -f -
  ...
  echo
  echo "Verifying Peering Connection on Acceptor (aks0) with curl command:"
